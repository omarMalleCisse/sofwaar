...
export const ProduitsBulletPoints = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070620] py-1.5 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48">
      <h1 className="text-4xl font-bold mt-3.5 text-white mb-1 text-center drop-shadow-lg">Gestion des BulletPoints</h1>
      <p className="text-blue-100 text-center mb-2">Bienvenue sur la page de gestion des bulletpoints.</p>
      ...
      <div className="flex flex-col items-center justify-center mt-6 bg-[#070620] text-blue-50">
        <TableGenerique
          ...
          onAdd={() => navigate('/add-bulletpoint')}
          addLabel="Ajouter un BulletPoint"
          renderActions={bp => (
            <>
              <button
                ...
                onClick={() => navigate(`/edit-bulletpoint/${bp.id}`)}
              >
                Éditer
              </button>
              <button
              ...
              <button
                ...
                onClick={() => navigate(`/bulletpoint/${bp.id}`)}
              >
                Détails
              </button>
            </>
...
export default ProduitsBulletPoints;
