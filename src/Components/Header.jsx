...
export const Header = () => {
  ...
  const WhatsAppButton = ({ className = "" }) => (
    <a
      ...
      className={`flex items-center justify-center p-2 rounded bg-green-500 hover:bg-green-600 text-white ${className}`}
    ...
    >
      ...
      <span className="hidden lg:inline ml-1 font-semibold">WhatsApp</span>
    </a>
  );
        ...
        <div className="relative z-10 flex items-center justify-between py-4 lg:py-6 ">
          ...
          <Link to="/">
            <img
              ...
              width={220}
              height={40}
              className="flex-shrink-0 w-[220px] h-[40px] lg:w-[260px] lg:h-[56px] transition-all duration-300"
              alt="Logo SoftWaar"
            />
          </Link>
